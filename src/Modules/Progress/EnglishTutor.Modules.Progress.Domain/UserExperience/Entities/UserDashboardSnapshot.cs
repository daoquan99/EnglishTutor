...
public sealed class UserDashboardSnapshot : Entity<Guid>
{
    ...
    public static UserDashboardSnapshot Create(
        Guid userId,
        ...
        string? currentLevel = null)
    {
        ...
        return new UserDashboardSnapshot
        {
            ...
            Date = date,
            CurrentLevel = string.IsNullOrWhiteSpace(currentLevel)
                ? "A1"
                : LearningActivityLog.Normalize(currentLevel, 10, "Current level"),
