...
{
    public static readonly Error DefinitionNotFound = Error.NotFound("Assessment definition", "requested");
    ...
    public static readonly Error ResultNotFound = Error.Conflict("Assessment attempt has not been graded yet.");
    public static readonly Error TargetLanguageNotFound = Error.NotFound("Target language", "active");
}
