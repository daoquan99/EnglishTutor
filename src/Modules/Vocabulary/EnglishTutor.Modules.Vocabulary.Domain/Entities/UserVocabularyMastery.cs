...
public sealed class UserVocabularyMastery : AggregateRoot<Guid>
{
    ...
    public static UserVocabularyMastery Create(Guid userId, Guid vocabularyItemId, LanguageCode targetLanguageCode)
    {
    ...
    public void RecordReview(bool isCorrect, int score)
    {
        ...
        NextReviewAtUtc = reviewedAtUtc.Add(CalculateReviewInterval());
        ...
        {
            AddDomainEvent(new VocabularyMasteredDomainEvent(UserId, VocabularyItemId, TargetLanguageCode.Value, reviewedAtUtc));
        }
    }
    ...
    public void MarkMastered()
    {
        ...
        NextReviewAtUtc = DateTime.UtcNow.AddDays(30);

        AddDomainEvent(new VocabularyMasteredDomainEvent(UserId, VocabularyItemId, TargetLanguageCode.Value, DateTime.UtcNow));
    }
