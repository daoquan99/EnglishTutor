...
public sealed class AiUsageCounter : Entity<Guid>
{
    ...
    public static AiUsageCounter Create(Guid userId, AiTaskType taskType, DateOnly usageDate, DateTime utcNow)
    {
    ...
    public void RecordRequest(int tokenCount, DateTime utcNow)
    {
        if (tokenCount < 0)
        {
