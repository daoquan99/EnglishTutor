...
public sealed class PromptTemplate : AggregateRoot<Guid>
{
    ...
    public static PromptTemplate Create(string name, AiTaskType taskType, string description, DateTime utcNow)
    {
    ...
    public PromptVersion AddVersion(string systemPrompt, string userPromptTemplate, bool activate, DateTime utcNow)
    {
        ...
        var version = PromptVersion.Create(Id, nextVersion, systemPrompt, userPromptTemplate, activate, utcNow);
