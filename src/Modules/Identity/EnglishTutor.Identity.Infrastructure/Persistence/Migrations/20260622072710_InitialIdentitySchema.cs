        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_refresh_token_families_user_sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_refresh_tokens_refresh_token_families_FamilyId",
                        column: x => x.FamilyId,
                        principalSchema: "identity",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_refresh_token_families_RevokedAtUtc",
                schema: "identity",
                table: "refresh_token_families",
                column: "RevokedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_refresh_token_families_SessionId",
                schema: "identity",
                table: "refresh_token_families",
                column: "SessionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_refresh_token_families_UserId_SessionId",
                schema: "identity",
                table: "refresh_token_families",
                columns: new[] { "UserId", "SessionId" });

            migrationBuilder.CreateIndex(
                name: "IX_refresh_tokens_FamilyId_consumed_at_utc",
                schema: "identity",
                table: "refresh_tokens",
                columns: new[] { "FamilyId", "consumed_at_utc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_sessions_RevokedAtUtc",
                schema: "identity",
                table: "user_sessions",
                column: "RevokedAtUtc");
