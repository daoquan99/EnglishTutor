...
public static class AiGatewayAdminEndpoints
{
    ...
    {
        ErrorType.NotFound => Results.Problem(detail: error.Message, statusCode: StatusCodes.Status404NotFound,
            title: "Not found", extensions: ErrorCode(error)),
        ErrorType.Conflict => Results.Problem(detail: error.Message, statusCode: StatusCodes.Status409Conflict,
