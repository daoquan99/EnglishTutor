    ...
    public partial class InitialLearning : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mode_definitions", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    description = table.Column<string>(type: "text", nullable: true),
                    difficulty_level = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_scenarios_mode_definitions_mode_definition_id",
                        column: x => x.mode_definition_id,
                        principalSchema: "learning",
                        principalTable: "mode_definitions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_scenarios_topics_topic_id",
                        column: x => x.topic_id,
                        principalSchema: "learning",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_topic_modes", x => x.id);
                    table.ForeignKey(
                        name: "FK_topic_modes_mode_definitions_mode_definition_id",
                        column: x => x.mode_definition_id,
                        principalSchema: "learning",
                        principalTable: "mode_definitions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_topic_modes_topics_topic_id",
                        column: x => x.topic_id,
                        principalSchema: "learning",
                        principalTable: "topics",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_mode_definitions_code",
                schema: "learning",
                table: "mode_definitions",
                column: "code",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_scenarios_mode_definition_id",
                schema: "learning",
                table: "scenarios",
                column: "mode_definition_id");

            migrationBuilder.CreateIndex(
                name: "ix_scenarios_topic_id_mode_definition_id_name",
                schema: "learning",
                table: "scenarios",
                columns: new[] { "topic_id", "mode_definition_id", "name" },
                unique: true,
                filter: "is_deleted = false");

            migrationBuilder.CreateIndex(
                name: "IX_topic_modes_mode_definition_id",
                schema: "learning",
                table: "topic_modes",
                column: "mode_definition_id");

            migrationBuilder.CreateIndex(
                name: "ix_topic_modes_topic_id_mode_definition_id",
                schema: "learning",
                table: "topic_modes",
                columns: new[] { "topic_id", "mode_definition_id" },
                unique: true);
