...
public sealed class ListEnabledModesForTopicQueryHandler : IQueryHandler<ListEnabledModesForTopicQuery, IReadOnlyList<TopicModeReadModel>>
{
    private readonly ITopicRepository _topicRepository;
    private readonly IModeDefinitionRepository _modeRepository;

    public ListEnabledModesForTopicQueryHandler(ITopicRepository topicRepository, IModeDefinitionRepository modeRepository)
    {
        _topicRepository = topicRepository;
        _modeRepository = modeRepository;
    }

    public async Task<Result<IReadOnlyList<TopicModeReadModel>>> Handle(ListEnabledModesForTopicQuery request, CancellationToken cancellationToken)
    {
        Topic? topic = null;
        ...
        {
            return Result.Failure<IReadOnlyList<TopicModeReadModel>>(
        ...
        IReadOnlyList<TopicModeReadModel> result = topic.TopicModes
