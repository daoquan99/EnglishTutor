...
public sealed class PracticeSessionEndedV2DomainEventHandler
    : IDomainEventHandler<PracticeSessionEndedDomainEvent>
{
    ...
    public PracticeSessionEndedV2DomainEventHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new PracticeSessionEndedIntegrationEventV2(
            ...
            ExplanationLanguageCode: domainEvent.ExplanationLanguageCode,
