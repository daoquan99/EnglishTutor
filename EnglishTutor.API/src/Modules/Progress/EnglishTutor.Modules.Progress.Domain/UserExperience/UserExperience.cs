...
public sealed class UserExperience : AggregateRoot<Guid>
{
    ...
    public static UserExperience Create(Guid userId, LanguageCode targetLanguageCode, DateTime utcNow)
    {
    ...
    public ExperienceTransaction GrantExp(int amount, string sourceType, Guid sourceId, string reason, DateTime utcNow)
    {
        var transaction = ExperienceTransaction.Create(Id, amount, sourceType, sourceId, reason, utcNow);
