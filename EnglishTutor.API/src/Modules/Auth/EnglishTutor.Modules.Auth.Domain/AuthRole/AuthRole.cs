...
public sealed class AuthRole : AggregateRoot<Guid>
{
    ...
    public void RaisePermissionsChanged(IReadOnlyCollection<Guid> affectedUserIds)
    {
        ArgumentNullException.ThrowIfNull(affectedUserIds);
        AddDomainEvent(new RolePermissionsChangedDomainEvent(Id, Name, affectedUserIds));
    }
