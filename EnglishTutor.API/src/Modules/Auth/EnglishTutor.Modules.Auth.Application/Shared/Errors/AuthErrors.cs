...
public static class AuthErrors
{
    ...
    public static readonly Error InvalidRoleSelection =
        Error.Validation("One or more roles are invalid or disabled.");

    public static readonly Error UserAlreadyActive =
        Error.Conflict("User is already active.");

    public static readonly Error UserAlreadySuspended =
        Error.Conflict("User is already suspended.");
}
