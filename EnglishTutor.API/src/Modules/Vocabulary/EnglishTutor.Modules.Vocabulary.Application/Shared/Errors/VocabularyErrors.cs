...
public static class VocabularyErrors
{
    ...
    public static readonly Error CannotMarkMastered =
        Error.Validation("Cannot mark as mastered. Requires: score >= 85, 3+ reviews, 2+ consecutive correct, and status not New.");
}
