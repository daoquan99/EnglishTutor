...
public sealed class SpeakingTurnResult : Entity<Guid>
{
    ...
    public static SpeakingTurnResult Create(
        ...
        DateTime utcNow,
        bool includePerformanceScoresInOverall = true)
    {
        ...
        return new SpeakingTurnResult
        {
            ...
            OverallScore = includePerformanceScoresInOverall
                ...
                : CalculateOverallScore(normalizedGrammarScore, normalizedVocabularyScore),
