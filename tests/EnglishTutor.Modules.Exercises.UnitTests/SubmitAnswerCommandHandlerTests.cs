...
public sealed class SubmitAnswerCommandHandlerTests
{
    ...
    public async Task Handle_Calls_Ai_Grading_For_Ai_Graded_Question()
    {
        ...
        var attempt = UserExerciseAttempt.Start(userId, exerciseSet.Id, "en", exerciseSet.TotalQuestions, UtcNow);
    ...
    private sealed class FakeExerciseAttemptRepository(UserExerciseAttempt attempt) : IExerciseAttemptRepository
    {
        ...
        public Task AddAsync(UserExerciseAttempt item, CancellationToken cancellationToken) =>
            Task.CompletedTask;
    ...
    private sealed class FakeExerciseSetRepository(ExerciseSet exerciseSet) : IExerciseSetRepository
    {
        ...
        public Task AddAsync(ExerciseSet item, CancellationToken cancellationToken) =>
            Task.CompletedTask;
    }
    ...
    {
        public DateTime UtcNow => SubmitAnswerCommandHandlerTests.UtcNow;
    }
}
